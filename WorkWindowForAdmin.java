...
public class WorkWindowForAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        deleteRouteTable = new javax.swing.JButton();
        ...
        date.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        printRoute.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        deleteRouteTable.setText("Очистить таблицу поставок товара");
        deleteRouteTable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deleteRouteTableActionPerformed(evt);
            }
        });
        ...
        jMenuItem1.setText("Добавить нового клиента");
        ...
        jMenuItem2.setText("Добавить новый товар");
        ...
        jMenuItem3.setText("Добавить нового водителя");
        ...
        jMenuItem5.setText("Добавить новую машину");
        ...
        jMenuItem6.setText("Добавить нового экспедитора");
        ...
        jMenuItem7.setText("Добавить логиста");
        ...
        jMenuItem8.setText("Добавить администратора");
        ...
        referen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                referenActionPerformed(evt);
            }
        });
        refer.add(referen);
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(deleteRouteTable, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap(22, Short.MAX_VALUE))
        );
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {
        AddExped addExped = new AddExped();
        addExped.setVisible(true);
    }

    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {
        AddLogist addLogist = new AddLogist();
        addLogist.setVisible(true);
    }
    ...
    private void deleteRouteTableActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WorkWindowForAdmin.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WorkWindowForAdmin().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton deleteRouteTable;
    ...
    private javax.swing.JMenu serv;
